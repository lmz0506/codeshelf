...
#[tauri::command]
#[specta::specta]
pub async fn list_api_endpoints() -> AppResult<Vec<ApiEndpoint>> {
...
#[tauri::command]
#[specta::specta]
pub async fn save_api_endpoint(mut endpoint: ApiEndpoint) -> AppResult<ApiEndpoint> {
    let mut endpoints = load_endpoints()?;
...
#[tauri::command]
#[specta::specta]
pub async fn delete_api_endpoint(id: String) -> AppResult<()> {
    let mut endpoints = load_endpoints()?;
